...
export function CategoryCard({ id, name, description, topState }: CategoryCardProps) {
  return (
    <Link href={`/rankings/${id}`} className="flex">
      <div className="group flex flex-col w-full rounded-lg border p-4 hover:border-foreground/20 hover:bg-muted/50 transition-all">
